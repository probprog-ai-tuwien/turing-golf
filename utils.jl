...
const Floats = Union{Float64, ForwardDiff.Dual{ForwardDiff.Tag{Turing.TuringTag, Float64}, Float64, 5}}
...
function plot_golfcourse(golf_course; fig_height::Int=8)
    ...
    golfer = plt_image.imread("golf_resources/golf_player.jpg")
    pond = plt_image.imread("golf_resources/golf_pond.png")
    hole = plt_image.imread("golf_resources/golf_hole.png")
